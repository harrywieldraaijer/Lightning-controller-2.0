...
Version 3.4 - 24 januari-2024 Added code for testbutton
...
function onMessage(event) {
    ...
    function testButton(buttonNumber){
        switch(buttonNumber) {
            case 1:
                lightLevel=document.getElementById("block1LightLevelNumber").value;
              break;
            case 2:
                lightLevel= document.getElementById("block1InterruptLightLevelNumber").value;
              break;
            case 3:
                lightLevel=document.getElementById("block2LightLevelNumber").value;
            break;
            case 4:
                lightLevel= document.getElementById("block2InterruptLightLevelNumber").value;
            break;
            case 5:
                lightLevel=document.getElementById("block3LightLevelNumber").value;
            break;
          }
        sendMessage="testButton".concat(lightLevel);
